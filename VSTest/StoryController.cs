namespace Kigg.VSTest
{
    ...
    public class StoryControllerTest
    {
        ...
        public void ShouldRenderForAllCategory()
        {
            ...
            Assert.IsInstanceOfType(controller.SelectedViewData, typeof(StoryListByCategoryData));
        ...
        public void ShouldRenderForSpecificTag()
        {
            ...
            Assert.IsInstanceOfType(controller.SelectedViewData, typeof(StoryListByTagData));
        ...
        public void ShouldRenderForSpecificPostedBy()
        {
            ...
            Assert.IsInstanceOfType(controller.SelectedViewData, typeof(StoryListByUserData));
        ...
        public void ShouldRenderSearchForSpecificSearchQuery()
        {
            ...
            Assert.IsInstanceOfType(controller.SelectedViewData, typeof(StoryListBySearchData));
        ...
        public void ShouldRenderDetailForSpecificStory()
        {
            ...
            Assert.IsInstanceOfType(controller.SelectedViewData, typeof(StoryDetailData));
