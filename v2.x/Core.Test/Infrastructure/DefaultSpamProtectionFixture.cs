...
namespace Kigg.Core.Test
{
    ...
    public class DefaultSpamProtectionFixture : BaseFixture
    {
        ...
        public void IsSpam_Should_Return_True_For_Story_When_Weight_Calculators_Return_More_Than_StoryThresold()
        {
            ...
            _httpForm.Expect(h => h.Get(It.IsAny<string>())).Returns("Dummy Content");
        ...
        public void IsSpam_Async_Should_Return_True_For_Story_When_Weight_Calculators_Return_More_Than_StoryThresold()
        {
            ...
            _httpForm.Expect(h => h.GetAsync(It.IsAny<string>(), It.IsAny<Action<string>>(), It.IsAny<Action<Exception>>())).Callback((string url, Action<string> onComplete, Action<Exception> onException) => onComplete("This is a dummy response"));
        ...
        public void IsSpam_Async_Should_Forward_To_Next_Handler_For_Story_When_Exception_Occurs()
        {
            ...
            _httpForm.Expect(h => h.GetAsync(It.IsAny<string>(), It.IsAny<Action<string>>(), It.IsAny<Action<Exception>>())).Callback((string url, Action<string> onComplete, Action<Exception> onException) => onException(new Exception()));
