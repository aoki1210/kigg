...
namespace Kigg.Core.Test
{
    ...
    public class SendMailFixture
    {
        ...
        public void CommentSubmitted_Should_SendMail()
        {
            ...
            story.ExpectGet(s => s.Subscribers).Returns(new List<IUser>());
        ...
        public void Start_Should_Subscribe_Events()
        {
            ...
            _eventAggregator.Expect(ea => ea.GetEvent<CommentMarkAsOffendedEvent>()).Returns(commentMarkedAsOffended.Object).Verifiable();
            commentMarkedAsOffended.Expect(e => e.Subscribe(It.IsAny<Action<CommentMarkAsOffendedEventArgs>>(), true)).Returns(new SubscriptionToken()).Verifiable();
        ...
        public void Stop_Should_Unsubscribe_Events()
        {
            ...
            _eventAggregator.Expect(ea => ea.GetEvent<CommentMarkAsOffendedEvent>()).Returns(commentMarkedAsOffended.Object).Verifiable();
            commentMarkedAsOffended.Expect(e => e.Subscribe(It.IsAny<Action<CommentMarkAsOffendedEventArgs>>(), true)).Returns(new SubscriptionToken());
            commentMarkedAsOffended.Expect(e => e.Unsubscribe(It.IsAny<SubscriptionToken>())).Verifiable();
