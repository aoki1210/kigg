namespace Kigg.Infrastructure.DomainRepositoryExtensions
{
    ...
    {
        public static bool IsUniqueEmail(this User forUser, string email)
        {
        ...
        public static decimal GetScore(this User forUser, DateTime startTimestamp, DateTime endTimestamp)
        {
