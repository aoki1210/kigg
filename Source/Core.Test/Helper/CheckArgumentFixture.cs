...
namespace Kigg.Core.Test
{
    public class CheckArgumentFixture
    {
        ...
        [Fact]
        public void IsNotInvalidDate_With_Min_Date_Should_Throw_Exception()
        {
            Assert.Throws<ArgumentOutOfRangeException>(() => Check.Argument.IsNotInvalidDate(DateTime.MinValue, "MinDate"));
        }

        [Fact]
        public void IsNotInvalidDate_With_Max_Date_Should_Throw_Exception()
        {
            Assert.Throws<ArgumentOutOfRangeException>(() => Check.Argument.IsNotInvalidDate(DateTime.MaxValue, "MaxDate"));
        }
