...
namespace Kigg.Core.Test
{
    ...
    public class CachingCategoryRepositoryFixture : DecoratedRepositoryFixture
    {
        ...
        private void FindAll()
        {
            ...
            cache.Setup(c => c.Set(It.IsAny<string>(), It.IsAny<ICollection<Category>>(), It.IsAny<DateTime>())).Verifiable();
            _innerRepository.Setup(r => r.FindAll()).Returns(new List<Category> { CreateStubCategory() }).Verifiable();
