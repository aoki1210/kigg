namespace Kigg.Web.ViewEngine
{
    ...
    public abstract class ThemeableVirtualPathProviderViewEngine : IViewEngine
    {
        ...
        protected VirtualPathProvider VirtualPathProvider
        {
            get
            {
                return vpp ?? (vpp = HostingEnvironment.VirtualPathProvider);
            }
        ...
        private string GetPath(ControllerContext controllerContext, IEnumerable<string> locations, IEnumerable<string> areaLocations, string locationsPropertyName, string name, string controllerName, string cacheKeyPrefix, bool useCache, bool checkPathValidity, ref bool incompleteMatch, out string[] searchedLocations)
        {
            ...
            string theme = (CurrentTheme != null)
                               ? CurrentTheme(controllerContext.HttpContext)
                               : string.Empty;
            ...
            return nameRepresentsPath ?
                   ...
                   GetPathFromGeneralName(controllerContext, viewLocations, name, controllerName, areaName, theme, cacheKey, out searchedLocations);
        }

        private string GetPathFromGeneralName(ControllerContext controllerContext, IList<ViewLocation> locations, string name, string controllerName, string areaName, string theme, string cacheKey, out string[] searchedLocations)
        {
