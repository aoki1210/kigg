...
namespace Kigg.Infrastructure.EF.Test
{
    ...
    public class StoryRepositoryFixture : EfBaseFixture
    {
        ...
        {
            database.Setup(d => d.InsertOnSubmit(It.IsAny<Story>())).Verifiable();
        ...
        public void Remove_Should_Use_Database()
        {
            ...
            database.Setup(d => d.DeleteOnSubmit(It.IsAny<Story>())).Verifiable();
        ...
        public void FindPublishedByCategory_Should_Return_Paged_Result()
        {
            ...
            var pagedResult = _storyRepository.FindPublishedByCategory(Stories[0].Category.Id, 0, 10);
        ...
        public void Search_Should_Return_Correct_Result()
        {
            ...
            database.Setup(db => db.StorySearchResult).Returns((new List<Guid> { story1.Id, story2.Id }).AsQueryable());
        ...
        public void FindPostedByUser_Should_Return_Correct_Result()
        {
            ...
            var pagedResult = _storyRepository.FindPostedByUser(Stories[0].User.Id, 0, 10);
        ...
        public void CountByCategory_Should_Return_Correct_Result()
        {
            ...
            var result = _storyRepository.CountByCategory(Stories[0].Category.Id);
